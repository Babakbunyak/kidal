                    ...
                    <table id="data-table" class="table table-bordered table-striped table-hover datatable datatable-role" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $post->id }}">
                                ...
                                <td>{{ $post->title }}</td>
                                <td>
                                    <img src="{{ Storage::url($post->banner) }}" width="200" alt="">
                                </td>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('admin.posts.edit', $user->id) }}" class="btn btn-info">
                                            <i class="fa fa-pencil-alt"></i>
                                        </a>
                                        <form onclick="return confirm('are you sure ? ')" class="d-inline" action="{{ route('admin.posts.destroy', $user->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
